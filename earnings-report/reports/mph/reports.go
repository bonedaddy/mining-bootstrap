...
func (m *Manager) GetRecentCredits24Hours() (*RecentCredits, error) {
	s := "getdashboarddata"
	m.FormatURL(s)
...
func (m *Manager) GetRecentCredits() (*[]RecentCredits, error) {
	s := "getdashboarddata"
	m.FormatURL(s)
	resp, err := http.Get(m.Config.URL)
	if err != nil {
...
func (m *Manager) FormatURL(action string) {
	m.Config.URL = fmt.Sprintf(m.Config.URL, m.Config.Coin, action, m.Config.MPHAPIKey)
}
